            ...
            <div className='flex gap-2 justify-between flex-col items-center'>
                ...
                <div className='flex  w-full  gap-5 '>
                    <button
                        ...
                        className='w-full font-bold bg-yellow-500 text-white   p-2 rounded-lg'>
                        Accept
                    </button>
                    <button
                        onClick={() => { props.setRidePopupPanel(false) }}
                        className='w-full  bg-gray-300 text-gray-700 font-bold p-2 rounded-lg'>
                        Ignore
                    </button>
                </div>
            </div>
