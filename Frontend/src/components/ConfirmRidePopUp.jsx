                ...
                <div className='w-full mt-5'>
                    <div className='flex items-center gap-5 p-3 border-b-2'>
                        ...
                        <div>
                            ...
                            <p className='text-sm -mt-1 text-gray-600'>BidhanNager,ssb sarani</p>
                        </div>
                    </div>
                    <div className='flex items-center gap-5 p-3 border-b-2'>
                        <LocateFixed />
                        <div>
                            <h3 className='text-lg font-medium'>562/11-A</h3>
                            <p className='text-sm -mt-1 text-gray-600'>Banachity,Durgapur</p>
                        </div>
                    </div>
                    <div className='flex items-center gap-5 p-3'>
                        <IndianRupee />
                        <div>
                            <h3 className='text-lg font-medium'>223 </h3>
                ...
                <div className='mt-6 w-full'>
                    ...
                    >
                        <input
                            ...
                            type="text"
                            className='bg-[#eee] border px-6 py-4 font-mono text-lg rounded-lg w-full mt-3'
                        ...
                        <div className='flex gap-5 '>
                            ...
                            }} className='w-full mt-5 text-lg flex justify-center bg-red-600 text-white font-semibold p-3 rounded-lg'>Cancel</button>
