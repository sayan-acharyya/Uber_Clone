// import { ChevronDown, MapPin, LocateFixed, IndianRupee } from 'lucide-react'
// import React from 'react'

// const ConfirmedRide = (props) => {
//   return (
//     <div className="relative bg-white rounded-t-3xl p-4 shadow-lg">
...
//           <div>
//             <h3 className="text-lg font-medium">952/11-A</h3>
//             <p className="text-sm text-gray-500">
//               Rampur P.C Road, Ahmedabad
//             </p>
//           </div>
//         </div>
...
//           <div>
//             <h3 className="text-lg font-medium">₹1248</h3>
...
//         }}
//         className="w-full mt-5 py-3 bg-green-600 text-white text-lg font-semibold rounded-xl hover:bg-green-700 transition">
//         Confirm
//       </button>
